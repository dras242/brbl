...
function performance_manager($conn,$query_year,$query_team) {
           ...
           top_performance($conn,$query_year,3,'avg','AVG',$query_team,'stats_batting');
           echo "</td>";
           echo "<td width=\"25%\" valign=\"top\">";
           top_performance($conn,$query_year,3,'hr','HR',$query_team,'stats_batting');
           echo "</td>";
           echo "<td width=\"25%\" valign=\"top\">";
           top_performance($conn,$query_year,3,'rbi','RBI',$query_team,'stats_batting');
           echo "</td>"; 
           echo "<td width=\"25%\" valign=\"top\">";
           top_performance($conn,$query_year,3,'r','Runs',$query_team,'stats_batting');
           echo "</td></tr>"; 
           echo "<tr><td><br></td></tr>";                      
           echo "<tr><td width=\"25%\" valign=\"top\">";
           top_performance($conn,$query_year,3,'h','Hits',$query_team,'stats_batting');   
           echo "</td>";
           echo "<td width=\"25%\" valign=\"top\">";
           top_performance($conn,$query_year,3,'sb','Stolen Bases',$query_team,'stats_batting');   
           echo "</td>";
           echo "<td width=\"25%\" valign=\"top\">";
           top_performance($conn,$query_year,3,'w','Wins',$query_team,'stats_pitching'); 
           echo "</td>";
           echo "<td width=\"25%\" valign=\"top\">";                   
           top_performance($conn,$query_year,3,'so','Strikeouts',$query_team,'stats_pitching');  
           echo "</td></tr>";            
           echo "<tr><td><br></td></tr>";                      
           echo "<tr><td width=\"25%\" valign=\"top\">";
           top_performance($conn,$query_year,3,'era','ERA',$query_team,'stats_pitching');   
           echo "</td>";
           echo "<td width=\"25%\" valign=\"top\">";
           top_performance($conn,$query_year,3,'sv','Saves',$query_team,'stats_pitching');   
           echo "</td>";
           echo "<td width=\"25%\" valign=\"top\">";
           top_performance($conn,$query_year,3,'ip','IP',$query_team,'stats_pitching'); 
           echo "</td>";
           echo "<td width=\"25%\" valign=\"top\">";                   
           top_performance($conn,$query_year,3,'g','Appearances',$query_team,'stats_pitching');  
           echo "</td></tr>";   
           echo "</table>";
}

function team_header($conn,$query_year,$query_team) {
           // GM, Manager, Current Recore
           $querystr="
           SELECT gm.first_name, gm.last_name, m.manager_name,m.filename,win.win,loss.loss
           FROM team t
           ...
           LEFT JOIN (SELECT team_id, count(*) AS win FROM game_team WHERE team_id=getTeamID('".$query_team."') AND 
                draft_year='".$query_year."' AND win_loss='W') win 
           ON win.team_id=t.team_id
           LEFT JOIN (SELECT team_id, count(*) AS loss FROM game_team WHERE team_id=getTeamID('".$query_team."') AND 
                draft_year='".$query_year."' AND win_loss='L') loss 
           ON loss.team_id=t.team_id
           ...
           echo "<table width=\"100%\"><tr>";
           echo "<td width=\"10%\"><img class=\"imagebuffer1\" alt=\"Team Logo ".$query_team."\" width=\"62\" height=\"60\" src=\"images/team-logos/".strtolower($query_team)."_62x60.jpg\">
               </td>"; 
...
function schedule($conn,$query_year,$query_team) {
               ...
               FROM game g
               WHERE g.league_year='".$query_year."' AND (team_id_away=getTeamID('".$query_team."') OR team_id_home=getTeamID('".$query_team."'))) g_inv
               ...
               echo "<table><tr><td colspan=\"2\"><span class=\"style12\">Series</span></td></tr>";
               for($i = 0; $i < $numofrows; $i++) {
                 $result->data_seek($i);
                 $row = $result->fetch_array(MYSQLI_ASSOC); 
                 $w_id = $row['w_id'];
                 ...
                 echo "<tr>";
                 echo "<td class=\"nowrap\" width=\"60%\" align=\"left\" valign=\"top\"><span class=\"style6\">W".$w_id." ".$pre."<a href=\"http://www.brbl-apba.com/teams.php?team=".$team."&view=main&year=".$query_year."\">".$team."</a></span></td>";
                 echo "<td class=\"nowrap\" width=\"40%\" align=\"center\" valign=\"top\"><span class=\"style6\">".$win."-".$loss."</span></td>";
                 echo "</tr>"; 
               }       
               echo "</table>";
               $result->close();
...
function season_results($conn,$query_team) {
               ...
               echo "<td align=\"center\">1-Run</td>";
               echo "<td align=\"center\">X-Inn</td>";
               echo "<td align=\"center\">East</td>";
               echo "<td align=\"center\">Central</td>";
               echo "<td align=\"center\">West</td>";
               echo "<td align=\"center\">Post Season</td>";
               echo "</tr>";
               ...
               for ($i = 0; $i < $numofrows; $i++) {
                   ...
                   echo "<td align=\"left\">".$league_year."</td>";
                   echo "<td align=\"center\">".$win."-".$loss."</td>";
                   echo "<td align=\"center\">".$pct."</td>";
                   echo "<td align=\"center\">".$gb."</td>";
                   echo "<td align=\"center\">".$place."</td>";
                   echo "<td align=\"center\">".$win_home."-".$loss_home."</td>";
                   echo "<td align=\"center\">".$win_away."-".$loss_away."</td>";
                   echo "<td align=\"center\">".$r_win."-".$r_loss."</td>";
                   echo "<td align=\"center\">".$x_win."-".$x_loss."</td>";
                   echo "<td align=\"center\">".$east_win."-".$east_loss."</td>";
                   echo "<td align=\"center\">".$central_win."-".$central_loss."</td>";            
                   echo "<td align=\"center\">".$west_win."-".$west_loss."</td>";
